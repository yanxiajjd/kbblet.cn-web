            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-8 md:p-12 flex flex-col justify-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                   <a 
                     href="https://qm.qq.com/q/nLG9o7UMwg"
                     target="_blank"
                     rel="noopener noreferrer"
                     className="bg-[#4CAF50] hover:bg-[#388E3C] text-white px-8 py-4 rounded-full transition-all duration-300 font-bold text-lg shadow-lg shadow-green-500/20 inline-block"
                   >
                     立即加入
                   </a>
                   <a 
                     href="https://docs.qq.com/aio/DZWJLeWxnQU9KVXNt"
                     target="_blank"
                     rel="noopener noreferrer"
                     className="bg-transparent border border-gray-300 text-gray-800 hover:bg-gray-100 px-8 py-4 rounded-full transition-all duration-300 font-bold text-lg"
                   >
                     查看教程
                   </a>
                </div>
              ...
              {/* 右侧图片区域 */}
               <div className="relative h-64 md:h-auto">
                  <img 
                    src="https://lf-code-agent.coze.cn/obj/x-ai-cn/276483463938/attachment/2025-07-26_12.39.22_20250728133937.png" 
